...
return {
    ...
    schema = {
        ...
        model = {
            ...
            choices = {
                ["google/gemini-2.5-pro-preview-06-05"] = { opts = { can_reason = true, has_vision = true } },
                ["google/gemini-2.5-flash-preview-05-20"] = { opts = { can_reason = true, has_vision = true } },
        ...
        max_tokens = {
            ...
            default = nil,
            desc =
            "The maximum number of tokens to include in a response candidate. Note: The default value varies by model",
            validate = function(n)
